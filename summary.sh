...
END{
	...
	printf "------------+---------------+---------------+---------------+---------------\n"
	printf "%12s|%8s%7.2f|%8s%7.2f|%8s%7.2f|%8s%7.2f\n","      Totel",sessionCounter[-1]+sessionCounter[0]+sessionCounter[1]+sessionCounter[2]+sessionCounter[3]+sessionCounter[4]+sessionCounter[5]+sessionCounter[6]+sessionCounter[7]+sessionCounter[8]+sessionCounter[9],"100%",tcpCounter[-1]+tcpCounter[0]+tcpCounter[1]+tcpCounter[2]+tcpCounter[3]+tcpCounter[4]+tcpCounter[5]+tcpCounter[6]+tcpCounter[7]+tcpCounter[8]+tcpCounter[9],"100%",udpCounter[-1]+udpCounter[0]+udpCounter[1]+udpCounter[2]+udpCounter[3]+udpCounter[4]+udpCounter[5]+udpCounter[6]+udpCounter[7]+udpCounter[8]+udpCounter[9],"100%",icmpCounter[-1]+icmpCounter[0]+icmpCounter[1]+icmpCounter[2]+icmpCounter[3]+icmpCounter[4]+icmpCounter[5]+icmpCounter[6]+icmpCounter[7]+icmpCounter[8]+icmpCounter[9],"100%";
}' $inputFile